...
export class DomList {    
    constructor (objectclass,parentdomid) {
     //   console.log(`In constructor of DomList with objectclass=${objectclass}`);
        var list = getElementsByClassName(objectclass,parentdomid);
        //console.log(list)    
        if (list ) {
            this.template    = list;
    ...
    ListLength() {
        ...
        console.log("childNodes: ", this.parentnode.childNodes)
        console.log("length: ", this.parentnode.childNodes.length)
        return this.parentnode.childNodes.length;
    }
}    
